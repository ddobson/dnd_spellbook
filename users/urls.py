...
urlpatterns = [
    ...
    re_path(r'^users/delete/$', djoser_views.UserDeleteView.as_view(),
            name='user-delete'),
    re_path(r'^users/create/$', djoser_views.UserCreateView.as_view(),
            name='user-create'),

    # Views are defined in Rest Framework JWT
    re_path(r'^users/login/$', jwt_views.ObtainJSONWebToken.as_view(),
            name='user-login'),
